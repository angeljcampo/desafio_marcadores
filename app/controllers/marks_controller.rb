class MarksController < ApplicationController
  ...
  def index
    @marks = Mark.all
    @mark_sorts = Sort.group(:mark_id).count
  end
  ...
  def create
    ...
    respond_to do |format|
      if @mark.save
        format.js { render nothing: true, notice: "Mark was successfully created." }
      else
  ...
  private
    ...
    def mark_params
      params.require(:mark).permit(:name, :url, :subcategory_id)
    end
end
